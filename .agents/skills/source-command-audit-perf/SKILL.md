---
name: "source-command-audit-perf"
description: "가벼움 예산 측정 — 시작 시간, 메모리, 번들 크기, LCP. 4원칙"
---

# source-command-audit-perf

Use this skill when the user asks to run the migrated source command `audit-perf`.
